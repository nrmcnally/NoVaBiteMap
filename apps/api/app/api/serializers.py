...
def fish_facts(profile: dict | None, species: SpeciesRecord | None) -> dict | None:
    ...
    return {
        ...
        "seasonalActivityByMonth": seasonal or [],
        ...
        # Reference content (research-populated).
        "family": profile.get("family"),
        "nativeStatus": profile.get("nativeStatus"),
        "statusNote": profile.get("statusNote"),
        "handlingNote": profile.get("handlingNote"),
        "diet": profile.get("diet"),
        "confusedWith": profile.get("confusedWith") or [],
        "stateRecordLb": profile.get("stateRecordLb"),
...
def location_summary(record: FishingLocationRecord) -> dict:
    ...
    return {
        ...
        "accessConditions": (record.details or {}).get("accessConditions") or [],
