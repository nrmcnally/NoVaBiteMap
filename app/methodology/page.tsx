    ...
    <div className="app-frame content-page">
      ...
      <main className="content-shell">
        ...
        <section className="limits-panel">
          ...
          <p>BiteMap computes the full provider-backed score matrix once when the forecast loads; scrubbing then selects already-computed values instead of rerunning every location and species in the browser. The selected time, ranked list, species-menu signals, result scores, and marker colors all use that same matrix. Times beyond the provider&apos;s final returned hour are disabled, and shared URLs retain the exact selected hour or date. This alpha uses one labeled regional weather anchor for map-wide comparison—not a separate microforecast at every access point. Air temperature is displayed for context and is not treated as water temperature.</p>
        </section>
