import type { AccessMethod, FishingLocation, SpeciesEvidence } from "./data";
...
type CoverageSeed = {
  ...
  name: string;
  waterbody: string;
  waterbodyType: FishingLocation["waterbodyType"];
  county: string;
  lat: number;
  lng: number;
...
const verifiedLocation = (seed: CoverageSeed): FishingLocation => ({
  id: seed.id,
  name: seed.name,
...
export const coverageLocations: FishingLocation[] = [
  ...
  verifiedLocation({ id: "walney-pond", name: "Walney Pond", waterbody: "Walney Pond", waterbodyType: "lake", county: "Fairfax", lat: 38.85373, lng: -77.43064, distanceMiles: 9, travelMinutes: 19, access: ["shore"], aliases: ["Ellanor C. Lawrence Park", "ECLP"], accessAuthority: fairfaxName, accessSourceUrl: sources.fairfaxFishing }),
  verifiedLocation({ id: "hidden-pond", name: "Hidden Pond Nature Center", waterbody: "Hidden Pond", waterbodyType: "lake", county: "Fairfax", lat: 38.772286, lng: -77.23874, distanceMiles: 11, travelMinutes: 21, access: ["shore"], accessAuthority: fairfaxName, accessSourceUrl: sources.fairfaxFishing, notice: "Fairfax County says fishing success is poor and fishing is mostly conducted through park programs. Confirm permission before planning an independent outing." }),
  ...
  verifiedLocation({ id: "pohick-bay", name: "Pohick Bay Regional Park", waterbody: "Pohick Bay", waterbodyType: "river", county: "Fairfax", lat: 38.678859, lng: -77.190496, distanceMiles: 24, travelMinutes: 36, access: ["shore", "kayak", "boat"], accessAuthority: novaName, accessSourceUrl: sources.novaPohick, evidence: pohickEvidence }),
  ...
  verifiedLocation({ id: "locust-shade", name: "Locust Shade Park", waterbody: "Locust Shade Pond", waterbodyType: "lake", county: "Prince William", lat: 38.531039, lng: -77.35487, distanceMiles: 35, travelMinutes: 46, access: ["shore", "boat"], accessAuthority: pwcName, accessSourceUrl: sources.pwcFishing, evidence: pwcLakeEvidence }),
