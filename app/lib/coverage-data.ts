...
export const coverageLocations: FishingLocationSeed[] = [
  ...
  verifiedLocation({ id: "carters-pond-pwfp", name: "Carter's Pond (Prince William Forest Park)", waterbody: "Carter's Pond", waterbodyType: "pond", county: "Prince William", lat: 38.5635977, lng: -77.3669338, distanceMiles: 33, travelMinutes: 53, access: ["shore"], accessAuthority: "National Park Service", accessSourceUrl: "https://www.nps.gov/prwi/planyourvisit/fishing.htm" }),
  verifiedLocation({ id: "merrimac-farm-pond", name: "Merrimac Farm WMA Pond", waterbody: "Merrimac Farm Pond", waterbodyType: "pond", county: "Prince William", lat: 38.62819, lng: -77.54072, distanceMiles: 37, travelMinutes: 60, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://dwr.virginia.gov/wma/merrimac-farm/" }),

  // --- Coverage sweep batch 3+4 (Fauquier->Culpeper + Shenandoah foothills) ---
  verifiedLocation({ id: "germantown-lake", name: "Germantown Lake (C.M. Crockett Park)", waterbody: "Germantown Lake", waterbodyType: "lake", county: "Fauquier", lat: 38.6212, lng: -77.7263, distanceMiles: 50, travelMinutes: 79, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fauquiercounty.gov/government/departments-h-z/parks-and-recreation/facilities/parks/c-m-crockett-park" }),
  verifiedLocation({ id: "abel-lake", name: "Abel Reservoir", waterbody: "Abel Reservoir", waterbodyType: "reservoir", county: "Stafford", lat: 38.4132, lng: -77.4971, distanceMiles: 50, travelMinutes: 80, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://staffordcountyva.gov/government/departments_p-z/parks_and_recreation/facilities___rentals/fishing_and_boating.php" }),
  verifiedLocation({ id: "lake-mooney", name: "Lake Mooney (Smith Lake)", waterbody: "Lake Mooney", waterbodyType: "reservoir", county: "Stafford", lat: 38.337, lng: -77.552, distanceMiles: 58, travelMinutes: 92, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://staffordcountyva.gov/news_detail_T5_R899.php" }),
  verifiedLocation({ id: "ni-river-reservoir", name: "Ni River Reservoir", waterbody: "Ni River Reservoir", waterbodyType: "reservoir", county: "Spotsylvania", lat: 38.2478, lng: -77.6029, distanceMiles: 66, travelMinutes: 106, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.spotsylvania.va.us/382/Reservoirs" }),
  ...
  verifiedLocation({ id: "lake-anna-sp", name: "Lake Anna (Lake Anna State Park)", waterbody: "Lake Anna", waterbodyType: "reservoir", county: "Spotsylvania", lat: 38.1139, lng: -77.8355, distanceMiles: 85, travelMinutes: 136, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.dcr.virginia.gov/state-parks/lake-anna", notice: "~75-90 min from the DC core. Striped bass and hybrid stripers are stocked; a major multi-use reservoir." }),
  verifiedLocation({ id: "phelps-pond", name: "Phelps Pond (C.F. Phelps WMA)", waterbody: "Phelps Pond", waterbodyType: "pond", county: "Fauquier", lat: 38.4619, lng: -77.7502, distanceMiles: 59, travelMinutes: 94, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://dwr.virginia.gov/waterbody/phelps-pond/" }),
  verifiedLocation({ id: "lake-arrowhead", name: "Lake Arrowhead (Luray)", waterbody: "Lake Arrowhead", waterbodyType: "lake", county: "Page", lat: 38.64081, lng: -78.3889, distanceMiles: 92, travelMinutes: 147, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://pagecounty.virginia.gov/232/Recreation-Facilities" }),
  ...
  verifiedLocation({ id: "bealers-ferry-pond", name: "Bealers Ferry Pond (USFS Accessible Site)", waterbody: "Bealers Ferry Pond", waterbodyType: "pond", county: "Page", lat: 38.7507, lng: -78.43293, distanceMiles: 93, travelMinutes: 149, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fs.usda.gov/r08/gwj/recreation/bealers-ferry-pond-accessible-fishing-site" }),
  verifiedLocation({ id: "lake-anna-accessible-pond", name: "Lake Anna State Park Accessible Fishing Pond", waterbody: "Lake Anna State Park Pond", waterbodyType: "pond", county: "Spotsylvania", lat: 38.11196, lng: -77.83114, distanceMiles: 85, travelMinutes: 136, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.dcr.virginia.gov/state-parks/lake-anna" }),
  verifiedLocation({ id: "n-fauquier-pond-1", name: "Northern Fauquier Community Park Pond 1", waterbody: "Northern Fauquier Pond 1", waterbodyType: "pond", county: "Fauquier", lat: 38.86861, lng: -77.82373, distanceMiles: 50, travelMinutes: 81, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fauquiercounty.gov/government/departments-h-z/parks-and-recreation/facilities/parks/northern-fauquier-community-park" }),
  verifiedLocation({ id: "n-fauquier-pond-2", name: "Northern Fauquier Community Park Pond 2", waterbody: "Northern Fauquier Pond 2", waterbodyType: "pond", county: "Fauquier", lat: 38.86886, lng: -77.82734, distanceMiles: 51, travelMinutes: 81, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fauquiercounty.gov/government/departments-h-z/parks-and-recreation/facilities/parks/northern-fauquier-community-park" }),
  verifiedLocation({ id: "lakeside-lake", name: "Lakeside Lake (Bowman Library)", waterbody: "Lakeside Lake", waterbodyType: "lake", county: "Frederick", lat: 39.10204, lng: -78.19139, distanceMiles: 78, travelMinutes: 125, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fcva.us/departments/parks-recreation/parks-facilities/parks/bowman-lake-trail-and-amphitheater" }),
  verifiedLocation({ id: "tomahawk-pond", name: "Tomahawk Pond Day Use Area (USFS)", waterbody: "Tomahawk Pond", waterbodyType: "pond", county: "Shenandoah", lat: 38.75861, lng: -78.84139, distanceMiles: 121, travelMinutes: 194, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fs.usda.gov/r08/gwj/recreation/tomahawk-pond-day-use-area", notice: "Small mountain pond; DWR stocks trout seasonally (~Oct 1-May 15). Far drive west." }),
  verifiedLocation({ id: "aquia-creek-widewater", name: "Aquia Creek at Widewater State Park", waterbody: "Aquia Creek", waterbodyType: "stream", county: "Stafford", lat: 38.4069, lng: -77.3274, distanceMiles: 45, travelMinutes: 72, access: ["shore", "wade"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.dcr.virginia.gov/state-parks/widewater" }),
  verifiedLocation({ id: "jetts-creek-lands-end", name: "Jett's Creek at Land's End WMA", waterbody: "Jett's Creek", waterbodyType: "stream", county: "King George", lat: 38.1625, lng: -77.1035, distanceMiles: 64, travelMinutes: 102, access: ["shore", "wade"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://dwr.virginia.gov/wma/lands-end/", notice: "Land's End WMA; a WMA access permit or valid VA license/registration is required. Tidal creek." }),
  verifiedLocation({ id: "conway-river", name: "Conway River (Rapidan WMA / SNP)", waterbody: "Conway River", waterbodyType: "stream", county: "Madison", lat: 38.4115, lng: -78.4394, distanceMiles: 102, travelMinutes: 163, access: ["shore", "wade"], accessAuthority: "Virginia DWR / NPS", accessSourceUrl: "https://dwr.virginia.gov/wma/rapidan/" }),
  verifiedLocation({ id: "west-naked-creek", name: "West Naked Creek (SNP)", waterbody: "West Naked Creek", waterbodyType: "stream", county: "Page", lat: 38.488, lng: -78.4994, distanceMiles: 103, travelMinutes: 165, access: ["shore", "wade"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.nps.gov/shen/planyourvisit/fishing.htm" }),
  verifiedLocation({ id: "east-naked-creek", name: "East Naked Creek (SNP)", waterbody: "East Naked Creek", waterbodyType: "stream", county: "Page", lat: 38.477, lng: -78.482, distanceMiles: 102, travelMinutes: 164, access: ["shore", "wade"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.nps.gov/shen/planyourvisit/fishing.htm" }),
  ...
  verifiedLocation({ id: "lake-thompson", name: "Lake Thompson (G.R. Thompson WMA)", waterbody: "Lake Thompson", waterbodyType: "lake", county: "Fauquier", lat: 38.95665, lng: -77.99332, distanceMiles: 62, travelMinutes: 100, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://dwr.virginia.gov/waterbody/lake-thompson/", notice: "DWR has discontinued trout stocking here indefinitely due to inconsistent water levels; current fishery is limited." }),
  ...
  verifiedLocation({ id: "sherando-park-lake", name: "Sherando Park Lake", waterbody: "Sherando Park Lake", waterbodyType: "lake", county: "Frederick", lat: 39.07263, lng: -78.18746, distanceMiles: 77, travelMinutes: 124, access: ["shore", "kayak"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.fcva.us/departments/parks-recreation/parks/sherando-park" }),
  verifiedLocation({ id: "cave-pond", name: "Cave Pond Pocket Park (Luray)", waterbody: "Cave Pond", waterbodyType: "pond", county: "Page", lat: 38.66436, lng: -78.47954, distanceMiles: 98, travelMinutes: 156, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.townofluray.com/parks/pocket-parks" }),
  verifiedLocation({ id: "big-gem-pond", name: "Big Gem Park Fishing Pond", waterbody: "Big Gem Park Pond", waterbodyType: "pond", county: "Page", lat: 38.48209, lng: -78.61683, distanceMiles: 111, travelMinutes: 178, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.townofshenandoah.com/parksrec/page/big-gem-park" }),
  verifiedLocation({ id: "long-pond-widewater", name: "Long Pond (Widewater State Park)", waterbody: "Long Pond", waterbodyType: "pond", county: "Stafford", lat: 38.4101, lng: -77.32528, distanceMiles: 45, travelMinutes: 72, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.dcr.virginia.gov/state-parks/widewater" }),
  verifiedLocation({ id: "yowell-meadow-pond", name: "Yowell Meadow Park Pond", waterbody: "Yowell Meadow Pond", waterbodyType: "pond", county: "Culpeper", lat: 38.47479, lng: -78.00047, distanceMiles: 72, travelMinutes: 116, access: ["shore"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://www.culpeperva.gov/" }),
  verifiedLocation({ id: "nanzattico-bay", name: "Nanzattico Bay at Land's End WMA", waterbody: "Nanzattico Bay", waterbodyType: "stream", county: "King George", lat: 38.16294, lng: -77.127, distanceMiles: 64, travelMinutes: 102, access: ["shore", "wade"], accessAuthority: "Virginia DWR", accessSourceUrl: "https://dwr.virginia.gov/wma/lands-end/", notice: "Land's End WMA (WMA access permit or VA license required). Tidal Rappahannock embayment; no exact-water fishery survey on file yet." }),
];
